...
这条记录就说明如果要去往 14.0.0.0 网络，IP 地址 14.215.177.38 先要和 255.0.0.0 进行位运算，然后再查表，看到 14.0.0.0，得知去往 Gateway 的网卡(IFace)是 16.12.1.1。
...
最后再出一道思考题: 下面这几个地址 127.0.0.1, localhost, 0.0.0.0 有什么不同？
