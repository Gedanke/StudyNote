...
众所周知，语言沟通的背后是说话人逻辑思维的过程，单句与单句间、事件与事件间，都是靠关联词联系起来的，所以这节课将从数学逻辑的角度，向你论述语言沟通背后的原理。
...
你会发现，"A^B"的蓝色区域，就是上面"A or B"区域减去"A and B"区域，即 $A^B = (A or B) - (A and B)$。
...
通过这三个反例可看出，缺乏逻辑性的关联词，虽然不会影响语义表达的正误，但却会让沟通变得冗杂，不够直接明了，从而降低了沟通效率。

所以，沟通表达与逻辑思维有着直接关系。接下来将讲解"因为...所以..."和"虽然...但是..."这对更体现逻辑思维的关联词，也请你好好揣摩一下这对关联词之间的相互逻辑关系。
...
正如下图所示，"因 为A，所以 B"，也可以用作描述"虽然非 A，但是 B"。
