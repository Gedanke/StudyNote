...
把上面的描述进行总结，来汇总一下逻辑回归输入向量、预测值和类别标签之间的关系，则有下面的流程图。
...
$$ \begin{array}{l} P\left(y_{i}=1 \mid x_{i}, w\right)=\operatorname{sigmoid}\left(x_{i} \cdot w\right)=1 /\left(
