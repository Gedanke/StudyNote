...
第 3 行，导入数据得到矩阵 X。为了还能求解出 b，我们需要对每个 xi 补充一个“1”；

第 4 行，导入数据得到真实值向量 ŷ。接下来，按照公式进行求解就可以了；

第 5 行，计算了 XTX 的结果；

第 6 行，对其求逆，得到了（XTX）-1；

第 7 行，再来对 XT 和 ŷ 计算矩阵乘法，得到最终的 w。
...
下一课时，我将向你讲解“08 | 加乘法则：如何计算复杂事件发生的概率？”
