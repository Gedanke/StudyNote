...
在专栏的 [05 | 求极值: 如何找到复杂业务的最优解](module_2/lecture_5.md) 和 [07 | 线性回归: 如何在离散点中寻找数据规律](module_2/lecture_7.md) 中反复提到过一个解决问题的通用框架，那就是形式化定义和最优化求解。

当遇到一个问题时，不妨试着用一个带参数的函数，来形式化定义这个问题；接着，通过各种各样求极值的办法，求解这个函数的最优值。
